...
class CoLabs_flickr extends WP_Widget {
	...
	function widget($args, $instance) {  
		...
		echo $before_widget;
		echo $before_title; ?>
		<?php if( $title ){ echo $title; }else{ _e('FLICKR PHOTOS','colabsthemes'); } ?>
        ...
        <div class="wrap">
            ...
            <p class="fr"><a href="http://www.flickr.com/photos/<?php echo $id; ?>/" target="_blank">More photos <img src="<?php bloginfo("template_url")?>/images/arrow_right.png" alt="image"/></a></p>
        </div>
   ...
   function form($instance) {
		...
		<p>
            <label for="<?php echo $this->get_field_id('desc'); ?>"><?php _e('Description (optional):','colabsthemes'); ?></label>
            <textarea type="text" name="<?php echo $this->get_field_name('desc'); ?>" id="<?php echo $this->get_field_id('desc'); ?>" ><?php echo $desc; ?></textarea>
        </p>         
        <p>
